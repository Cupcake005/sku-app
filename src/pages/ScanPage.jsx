    ...
    <div className="pb-24 max-w-md mx-auto relative min-h-screen"> 
      ...
      <div className="bg-white p-4 rounded-lg shadow-md mb-4 sticky top-0 z-40">
        ...
        <form onSubmit={handleSearch} className="relative mb-4">
          ...
          {/* TOMBOL PASTE / CLEAR */}
          {searchQuery ? (
             <button type="button" onClick={clearSearch} className="absolute right-3 top-2 bg-gray-100 p-1.5 rounded-full text-gray-500 hover:bg-gray-200 transition">
                <X size={16} />
             </button>
          ) : (
             <button type="button" onClick={handlePaste} className="absolute right-3 top-2 bg-gray-100 p-1.5 rounded-full text-gray-500 hover:bg-blue-100 hover:text-blue-600 transition" title="Tempel dari Clipboard">
                <Clipboard size={16} />
             </button>
          )}
